...

{
  ...
  inputs = {
    ...
    # nixvim follows nixpkgs so plugin dependencies resolve from the same
    # package set as konductor. Prevents hash mismatches on vim plugins
    # whose upstream source changes between nixpkgs revisions.
    nixvim = {
